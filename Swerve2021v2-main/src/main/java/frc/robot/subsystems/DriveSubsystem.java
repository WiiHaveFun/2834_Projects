...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    m_fr = new SwerveModule(DriveConstants.kFrontRightDriveMotorID, 
                            ...
                            DriveConstants.kFrontRightSteerCANCoderID, 
    ...
    m_fl = new SwerveModule(DriveConstants.kFrontLeftDriveMotorID, 
                            ...
                            DriveConstants.kFrontLeftSteerCANCoderID, 
    ...
    m_rl = new SwerveModule(DriveConstants.kRearLeftDriveMotorID, 
                            ...
                            DriveConstants.kRearLeftSteerCANCoderID, 
    ...
    m_rr = new SwerveModule(DriveConstants.kRearRightDriveMotorID, 
                            ...
                            DriveConstants.kRearRightSteerCANCoderID, 
  ...
  /**
   * Sets the states of the swerve modules using a 2D double array
   * 
   * @param desiredStates
   */
  ...
  /**
   * Sets the states of the swerve modules using a SwerveModuleStates array
   * 
   * @param desiredStates
   */
   ...
   * @param desiredStates
   */
  public void setModuleStatesReverse(SwerveModuleState[] desiredStates) {
    m_fr.setState(-desiredStates[0].speedMetersPerSecond, desiredStates[0].angle.getDegrees(), true);
    m_fl.setState(-desiredStates[1].speedMetersPerSecond, desiredStates[1].angle.getDegrees(), true);
    m_rl.setState(-desiredStates[2].speedMetersPerSecond, desiredStates[2].angle.getDegrees(), true);
    m_rr.setState(-desiredStates[3].speedMetersPerSecond, desiredStates[3].angle.getDegrees(), true);
   ...
   * Returns the pose of the robot.
   * 
   * @return The robot's pose in reverse.
   */
  public Pose2d getReversePose() {
    
    Pose2d reversePose = new Pose2d(-m_odometry.getPoseMeters().getX(), -m_odometry.getPoseMeters().getY(), new Rotation2d(-m_odometry.getPoseMeters().getRotation().getRadians()));
    return reversePose;
  }
  ...
  /**
   * Gets the command to follow a trajectory
   * 
   * @param trajectory The trajectory to follow
   * @param thetaController The theta controller to use to control heading
   * @return The command to follow a trajectory
   */
  public SwerveControllerCommand getSwerveControllerCommand(Trajectory trajectory, ProfiledPIDController thetaController) {
  ...
  /**
   * Gets the command to follow a trajectory in reverse
   * 
   * @param trajectory The trajectory to follow
   * @param thetaController The theta controller to use to control heading
   * @return The command to follow a trajectory in reverse
   */
  public SwerveControllerCommand getReverseSwerveControllerCommand(Trajectory trajectory, ProfiledPIDController thetaController) {
    SwerveControllerCommand swerveControllerCommand =
        new SwerveControllerCommand(
            trajectory,
            this::getReversePose, // Functional interface to feed supplier
            DriveConstants.kDriveKinematics,
            // Position controllers
            new PIDController(AutoConstants.kPXController, 0, 0),
            new PIDController(AutoConstants.kPYController, 0, 0),
            thetaController,
            this::setModuleStatesReverse,
            this);
