...
public class BarrelAuto extends SequentialCommandGroup {
   ...
   * */
  public BarrelAuto(DriveSubsystem m_driveSubsystem) {
    trajectories = new Trajectories();
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new ResetOdometry(m_driveSubsystem, trajectories.barrelTrajectory, true),
                m_driveSubsystem.getSwerveControllerCommand(trajectories.barrelTrajectory, trajectories.thetaController),
