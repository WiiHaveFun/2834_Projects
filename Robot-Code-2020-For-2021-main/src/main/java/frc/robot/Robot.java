...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("Objects Detected", m_robotContainer.socket.getObjectCount(m_robotContainer.socket.getObjects()));
    // System.out.println(m_robotContainer.socket.getObjects());
  }
